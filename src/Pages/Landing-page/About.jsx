  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    >
      ...
      <div className="p-4 text-center">
        <h3 className="text-xl font-semibold text-[#0f0f0f]">Mai Mahmoud</h3>
    ...
    >
      ...
      />
      <div className="p-4 text-center">
        <h3 className="text-xl font-semibold text-[#0f0f0f]">Heba Mohammed</h3>
    ...
    >
      ...
      />
      <div className="p-4 text-center">
        <h3 className="text-xl font-semibold text-[#0f0f0f]">Adel Ezzat</h3>
    ...
    >
      ...
      />
      <div className="p-4 text-center">
        <h3 className="text-xl font-semibold text-[#0f0f0f]">Arwa Zakria</h3>
        <p className="text-[#DEB041]">Lead Educator</p>
      </div>
    </div>
    ...
    >
      ...
      />
      <div className="p-4 text-center">
        <h3 className="text-xl font-semibold text-[#0f0f0f]">Abdullah Ashraf</h3>
        <p className="text-[#DEB041]">Lead Educator</p>
      </div>
    </div>
  </div>
