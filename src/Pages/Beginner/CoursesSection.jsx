  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0f0f0f]">
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen z-10">
        <div className="relative bg-opacity-60 p-6 rounded-lg text-center z-10">
          ...
          <p className="mt-6 text-2xl text-white max-w-2xl mx-auto leading-relaxed">
            Unlock your potential with our diverse course offerings. Join us on a journey to elevate your skills and knowledge.
          </p>
        </div>

        {/* Dynamic Button */}
        <div className="mt-8 relative">
          <button className="relative overflow-hidden bg-gradient-to-r from-[#DEB041] via-[#998443] to-[#0f0f0f] text-white px-8 py-4 rounded-lg shadow-lg transition-transform duration-300 transform hover:scale-105 hover:shadow-2xl">
            Explore Courses
          </button>
        </div>

        {/* Scroll Icon with Floating Circle */}
