...
const Footer = () => {
  return (
    <footer
      id="footer"
      className="bg-gradient-to-r from-[#998443] via-[#DEB041] to-[#0f0f0f]  text-white py-12 px-4"
    >
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20 px-4 lg:px-0">
        ...
        >
          ...
          <p className="text-sm text-[#E5E7EB] leading-relaxed">
            We provide cutting-edge programming courses designed to empower
            individuals to thrive in today’s fast-paced tech world. From
            beginner to advanced, we tailor learning paths to suit your goals.
          </p>
        </div>
        ...
        <div className="space-y-6" data-aos="fade-up" data-aos-duration="1000">
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex items-center space-x-2">
              <FaPhoneAlt />
              <span>+20 100 205 1752</span>
            </li>
            <li className="flex items-center space-x-2">
              <FaEnvelope />
              <span>Basatha@gmail.com</span>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-6" data-aos="fade-up" data-aos-duration="1000">
          ...
          <div className="flex space-x-4">
            <a
              ...
              className="group hover:text-[#000] transition duration-300 transform"
            >
              <FaFacebookF size={24} />
        ...
        <div className="space-y-6" data-aos="fade-up" data-aos-duration="1000">
          <img src={nlogo} className="w-[150px]" />
        </div>
      </div>
