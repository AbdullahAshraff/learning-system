    ...
    <Modal sx={modalStyle} open={modalOpen}>
      <Box sx={boxStyle}>
        ...
        >
          <Button
            // size="small"
            className='!text-indigo-700 !border-indigo-700 !border-2 !border-solid !p-1 md:!p-2'
            sx={{ marginRight: '10px', borderColor: 'white' }}
            variant="outlined"
          ...
          <Button
            className='!bg-indigo-700 !border-indigo-700 !border-2 !border-solid !p-1 md:!p-2'
