...
const NavBar = () => {
  ...
  const handleProfileNavigation = () => {
    const profileUsername = user.username || user.name.replace(/\s+/g, '-').toLowerCase();
      ...
      <nav className="max-w-7xl mx-auto flex justify-between items-center py-4 px-6">
        ...
        <div className="relative">
          ...
          {showDropdown && userLogged && (
            <div className="absolute right-0 mt-2 w-60 bg-white rounded-xl shadow-lg py-5 px-3 z-50 
          ...
          {showDropdown && !userLogged && (
            <div className= "absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-4 z-50 
              transition-all duration-300 ease-in-out transform origin-top-right scale-95 hover:scale-100">
              <button
