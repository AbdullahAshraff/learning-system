...
import { welcomeVideos, htmlVideos, cssVideos, jsVideos, routingVideo, formvalidationVideos, reduxVideos } from './Data/backendData.js';
const useVideoCourse = () => {
  ...
  const markVideoAsWatched = (section, index) => {
    const updateWatchedState = {
      ...
      node: setWatchedHtml,
      nodejs: setWatchedCss,
      express: setWatchedJs,
      mongo: setWatchedRouting,
      auth: setWatchedForm,
      deploy: setWatchedRedux,
    };
