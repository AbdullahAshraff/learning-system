...
import { welcomeVideos, htmlVideos, cssVideos, jsVideos, routingVideo, formvalidationVideos, reduxVideos } from './Data/beginercourseData.js';
const useVideoCourse = () => {
  ...
  const markVideoAsWatched = (section, index) => {
    const updateWatchedState = {
      ...
      programming: setWatchedHtml,
      coding: setWatchedCss,
      proglang: setWatchedJs,
      python: setWatchedRouting,
      problems: setWatchedForm,
      career: setWatchedRedux,
    };
    ...
    if (
        ...
        isAllVideosWatched(watchedRedux) // All "redux" videos watched
      ) {
