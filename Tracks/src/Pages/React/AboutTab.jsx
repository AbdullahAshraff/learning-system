...
import Frontend from '../../assets/React.jpeg';
    ...
    <div className="bg-white p-10 relative overflow-hidden rounded-2xl shadow-lg perspective-1500">
      ...
      <div className="relative z-10 max-w-5xl mx-auto p-8 flex flex-col items-center">
        ...
        >
          <div className="relative w-full h-full cursor-pointer">
            ...
            <motion.div className="absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-50 rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
              <h3 className="text-2xl font-bold cursor-pointer">Explore the React Js Development</h3>
            </motion.div>
          </div>
        </motion.div>
        ...
        <div className="w-full text-left">
          ...
          >
            Zero To Hero in React Js With Mosh Hamedani
          </motion.h2>

          <motion.p
            className="text-lg text-gray-700 mb-6 leading-relaxed px-4 md:px-0"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.6 }}
          >
            The <span className="font-semibold text-[#DEB041]">React.js Development</span> track focuses on building skills in the React library, a powerful tool for creating dynamic and interactive user interfaces. 
            You will learn the core concepts of React, including components, props, state management, and the component lifecycle, as well as hooks and context for advanced state management. 
            This track will guide you through the process of building modern web applications, emphasizing the importance of reusable components and efficient data flow. 
            By the end of the track, you will have a solid understanding of React.js and the ability to develop scalable, high-performance applications that provide exceptional user experiences.
