    ...
    <div className="bg-white p-10 relative overflow-hidden rounded-2xl shadow-lg perspective-1500">
      ...
      <div className="relative z-10 max-w-5xl mx-auto p-8 flex flex-col items-center">
        ...
        >
          <div className="relative w-full h-full cursor-pointer">
            ...
            <motion.div className="absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-50 rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
              <h3 className="text-2xl font-bold cursor-pointer">Explore the Backend Development</h3>
            </motion.div>
          </div>
        </motion.div>
        ...
        <div className="w-full text-center">
          ...
          >
            Zero To Hero in Backend Development With Mosh Hamedani
          </motion.h2>
          ...
          >
            The <span className="font-semibold text-[#DEB041]">Backend Development</span> track focuses on building skills in essential technologies such as Node.js, Express.js, and databases like MongoDB and MySQL. 
            You will learn how to create dynamic and secure web applications, ensuring seamless user experiences. 
            This track will guide you through the process of developing modern backend systems, from handling server-side logic to managing authentication and data storage. 
            By the end of the track, you will have a comprehensive understanding of backend development and the ability to build robust, scalable systems that communicate efficiently with the frontend.
