  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-xs text-center cursor-pointer">
      ...
      <p className="text-gray-600 mt-4 text-left">
        ...
        He is a full stack developer with over two decades of experience in software development. He specializes in technologies like JavaScript, React, Angular, Node.js, and .NET. 
      </p>
