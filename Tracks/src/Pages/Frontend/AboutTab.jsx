    ...
    <div className="bg-white p-10 relative overflow-hidden rounded-2xl shadow-lg perspective-1500">
      ...
      <div className="relative z-10 max-w-5xl mx-auto p-8 flex flex-col items-center">
        ...
        >
          <div className="relative w-full h-full cursor-pointer">
            ...
            <motion.div className="absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-50 rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
              <h3 className="text-2xl font-bold">Explore the Frontend Development</h3>
            </motion.div>
          </div>
        </motion.div>
        ...
        <div className="w-full text-center">
          ...
          >
            Zero To Hero in Frontend Development With Beau Carnes
          </motion.h2>
          ...
          >
            The <span className="font-semibold text-[#DEB041] ">Frontend Development</span> track focuses on building skills in essential technologies such as HTML, CSS, and JavaScript, along with libraries like React and frameworks like Tailwind CSS. 
            You will learn to create interactive and responsive web applications, ensuring exceptional user experiences.
            This track will guide you through the process of developing modern web applications, from basic HTML structure to
            advanced state management techniques. By the end of the track, you will have a comprehensive understanding of
            frontend development and the ability to create stunning, user-friendly interfaces.
          </motion.p>

          {/* Course Information */}
          <div className="flex flex-wrap space-x-8 mb-6">
