...
// function StartPage() {
//   return (
//     <div id="startpage" className="flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 to-blue-50 p-4 relative">
...
//           Let's Start <GiStrong className="text-6xl text-500 text-black animate__animated animate__tada" aria-label="Strong Icon" />
//         </h1>
...
//           {/* Beginner Button */}
//             <button className="bg-[#DEB041] relative flex w-[200px] h-[60px] items-center px-6 py-3 overflow-hidden font-semibold transition-all rounded-lg group shadow-lg hover:bg-[#CDAA30] animate__animated animate__bounceIn">
...
//               {/* Experienced Button */}
//               <button className="bg-black relative flex w-[200px] h-[60px] items-center px-6 py-3 overflow-hidden font-semibold transition-all rounded-lg group shadow-lg hover:bg-gray-800 animate__animated animate__bounceIn">
...
//           <FaHandsHelping className="text-4xl animate__animated animate__fadeInUp text-[#DEB041]" aria-label="Helping Hands Icon" />
//           <p className="text-lg font-medium mt-2">Guided Learning</p>
//         </div>
//         <div className="flex flex-col items-center">
//           <FaBookReader className="text-4xl animate__animated animate__fadeInUp text-[#000]" aria-label="Book Reader Icon" />
//           <p className="text-lg font-medium mt-2">Comprehensive Materials</p>
//         </div>
//         <div className="flex flex-col items-center">
//           <FaLaptopCode className="text-4xl animate__animated animate__fadeInUp text-[#DEB041]" aria-label="Laptop Code Icon" />
//           <p className="text-lg font-medium mt-2">Hands-on Projects</p>
//         </div>
//         <div className="flex flex-col items-center">
//           <IoRocketSharp className="text-4xl animate__animated animate__fadeInUp text-[#000]" aria-label="Rocket Icon" />
...
import React from 'react';
import 'animate.css';
import { GiStrong, GiGraduateCap, GiSkills } from "react-icons/gi"; // New Icons
import { FaRegSmileWink, FaHandsHelping, FaBookReader, FaLaptopCode } from 'react-icons/fa'; // Fun Icons
import { IoRocketSharp } from 'react-icons/io5'; // Rocket Icon for Excitement
    ...
    <div id="startpage" className="flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 to-blue-50 p-4 relative">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center mt-8 w-full max-w-6xl gap-8 z-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center gap-6">
          ...
          <button style={{backgroundColor:'black'}} className=" relative flex w-[200px] h-[60px] items-center px-6 py-3 overflow-hidden font-semibold transition-all rounded-lg group shadow-lg hover:bg-gray-800 animate__animated animate__bounceIn">
            <span className="absolute inset-0 w-full h-full transition-transform bg-indigo-600 rounded-lg group-hover:translate-x-full group-hover:animate-pulse"></span>
            <span className="relative z-10 text-white text-lg flex items-center gap-2 transition-all duration-300 transform group-hover:scale-110 group-hover:rotate-3">
              <GiGraduateCap className="text-2xl" aria-label="Graduation Cap Icon" /> Beginner
            </span>
          ...
          <button style={{backgroundColor:'#DEB041'}} className=" relative flex w-[200px] h-[60px] items-center px-6 py-3 overflow-hidden font-semibold transition-all rounded-lg group shadow-lg hover:bg-[#CDAA30] animate__animated animate__bounceIn">
            <span className="absolute inset-0 w-full h-full transition-transform bg-green-600 rounded-lg group-hover:translate-x-full group-hover:animate-pulse"></span>
            <span className="relative z-10 text-white text-lg flex items-center gap-2 transition-all duration-300 transform group-hover:scale-110 group-hover:rotate-3">
              <GiSkills className="text-2xl" aria-label="Skills Icon" /> Have Experience
            </span>
